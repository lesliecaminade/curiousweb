...
class besavilla_126():
    def __init__(self):
        ...
        choice_a = '-11.49 #'
        choice_b = choice(-11.49, round = 2)
        choice_c = choice(-11.49, round = 2)
        choice_d = choice(-11.49, round = 2)
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""What is the maximum value of y = x^6 - 12x?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_127():
    def __init__(self):
        ...
        choice_a = 's^2 / 2 #'
        choice_b = f"""s^2 / {random.randint(3,10)}"""
        choice_c = f"""s^2 / {random.randint(3,10)}"""
        choice_d = f"""s^2 / {random.randint(3,10)}"""
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The sum of two numbers is S. What is the minimum value of the sum of their squares?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_128():
    def __init__(self):
        ...
        choice_a = '128 #'
        choice_b = random.randint(-200, 200)
        choice_c = random.randint(-200, 200)
        choice_d = random.randint(-200, 200)
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""For a function y = x (12 - 2x )^2, if the maximum value is M and the minimum value is N, determine M + N."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_129():
    def __init__(self):
        ...
        choice_a = '4 #'
        choice_b = random.randint(-100, 100)
        choice_c = random.randint(-100, 100)
        choice_d = random.randint(-100, 100)
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""For the function 2x^2 - 4xy + 3y^2 - 8x + 8y - 1 = 0, If the maximum point is (x1, y1) and the minimum point is (x2, y2), calculate x1 + y1 + x2 + y2   """
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_130():
    def __init__(self):
        ...
        choice_a = f"""(2/3) K #"""
        choice_b = f"""({Fraction(random.randint(-9,9), random.randint(-9,9))}) K"""
        choice_c = f"""({Fraction(random.randint(-9,9), random.randint(-9,9))}) K"""
        choice_d = f"""({Fraction(random.randint(-9,9), random.randint(-9,9))}) K"""
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The sum of two numbers is K. The product of one by the square of the other is to be a maximum. What is one of the numbers?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_131():
    def __init__(self):
        ...
        self.question = f"""The sum of two numbers is K. The product of by the cube of the other is to be a maximum. What is one of the numbers?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_132():
    def __init__(self):
        ...
        choice_a = '(1/4) S^3 #'
        choice_b = f"""({Fraction(random.randint(-9, 9), random.randint(-9,9))} S^3"""
        choice_c = f"""({Fraction(random.randint(-9, 9), random.randint(-9,9))} S^3"""
        choice_d = f"""({Fraction(random.randint(-9, 9), random.randint(-9,9))} S^3"""
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The sum of the two numbers is S. What is the maximum value of the sum of their cubes?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_133():
    def __init__(self):
        ...
        choice_a = '8.49 meters #'
        choice_b = str(round(random.uniform(5,20),2)) + ' meters'
        choice_c = str(round(random.uniform(5,20),2)) +' meters' 
        choice_d = str(round(random.uniform(5,20),2)) + ' meters'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The hypoteneuse of a right triangle is 12 meters. Find one of the legs if the area is maximum."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_134():
    def __init__(self):
        ...
        choice_a = '33.8 meters #'
        choice_b = str(round(random.uniform(10,100),1)) + ' meters'
        choice_c = str(round(random.uniform(10,100),1)) + ' meters'
        choice_d = str(round(random.uniform(10,100),1)) + ' meters'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The hypoteneuse of a right triangle is 14 meters. Find its perimeter if its area is maximum."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_135():
    def __init__(self):
        ...
        choice_a = '56.3 m^2 #'
        choice_b = str(round(random.uniform(1,100),1)) + ' m^2'
        choice_c = str(round(random.uniform(1,100),1)) + ' m^2'
        choice_d = str(round(random.uniform(1,100),1)) + ' m^2'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The hypoteneuse of a right triangle is 15 m. Find its maximum area."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_136():
    def __init__(self):
        ...
        choice_a =  '48.3 meters #'
        choice_b = f'{round(random.uniform(10,100),1)} meters'
        choice_c = f'{round(random.uniform(10,100),1)} meters'
        choice_d = f'{round(random.uniform(10,100),1)} meters'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The hypoteneuse of a right triangle is 20 meters. If the area is to be maximum, what is its perimeter?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_137():
    def __init__(self):
        ...
        choice_a = '200 m #'
        choice_b = f'{random.randint(100,1000)}0 m'
        choice_c = f'{random.randint(100,1000)}0 m'
        choice_d = f'{random.randint(100,1000)}0 m'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""A rectangular lot having an area of 5000 m^2 is to be fenced on 3 sides. Find the least amount of fencing needed."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_138():
    def __init__(self):
        ...
        choice_a = '2 #'
        choice_b = f'{Fraction(random.randint(1,9), random.randint(1,9))}'
        choice_c = f'{Fraction(random.randint(1,9), random.randint(1,9))}'
        choice_d = f'{Fraction(random.randint(1,9), random.randint(1,9))}'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""A rectangular lot having an area of 5000 m^2 is to be fenced on sides. To have at the amount of fencing, what should be the ratio of its length to width?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_139():
    def __init__(self):
        ...
        choice_a = '50 #'
        choice_b = f'{random.randint(10,100)}'
        choice_c = f'{random.randint(10,100)}'
        choice_d = f'{random.randint(10,100)}'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""What is the area in square meters of the rectangle of maximum perimeter inscribed in a circle having a diameter of 10 meters?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_140():
    def __init__(self):
        ...
        choice_a = '100 #'
        choice_b = f'{random.randint(1,9)}0'
        choice_c = f'{random.randint(1,9)}0'
        choice_d = f'{random.randint(1,9)}0'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The hypoteneuseof a right triangle is 20 cm. What is the maximum possible area of the triangle is square centimeters?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_141():
    def __init__(self):
        ...
        choice_a = '1.414 * breadth'
        choice_b = f'{round(random.uniform(1,5),2)}'
        choice_c = f'{round(random.uniform(1,5),2)}'
        choice_d = f'{round(random.uniform(1,5),2)}'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The strength of a rectangular beam varies jointly with the breadth and the square of the depth. Find the depth of the strongest beam which can be cut from a log of a given diameter."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_142():
    def __init__(self):
        ...
        choice_a = '58.98 cm #'
        choice_b = f'{round(random.uniform(10,100),2)} cm'
        choice_c = f'{round(random.uniform(10,100),2)} cm'
        choice_d = f'{round(random.uniform(10,100),2)} cm'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""What is the depth of the strongest beam that can be cut from a log whose diameter is 73.23 cm if its strength is directly proportional to the product of the width and the square of the depth?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_143():
    def __init__(self):
        ...
        choice_a = '8.16 by 1.63 #'
        choice_b = f'{round(random.gauss(8.16,3),2)} by {round(random.gauss(1.63, 3),2)}'
        choice_c = f'{round(random.gauss(8.16,3),2)} by {round(random.gauss(1.63, 3),2)}'
        choice_d = f'{round(random.gauss(8.16,3),2)} by {round(random.gauss(1.63, 3),2)}'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The strength of a rectangular beam varies as the product of the breadth and the square of the depth. Find the dimensions of the strongest beam that can be cut from a log whose cross section is an ellipse having an equation of x^2/16 + y^2/25 = 1"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_144():
    def __init__(self):
        ...
        choice_a = '649519 cu.cm. #'
        choice_b = f'{random.randint(600_000, 700_000)} cu.cm.'
        choice_c = f'{random.randint(600_000, 700_000)} cu.cm.'
        choice_d = f'{random.randint(600_000, 700_000)} cu.cm.'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The stiffness of a rectangular beam varies as the product of the breadth and the cube of the depth. Find the volume of the stiffest beam that can be cut from a cylindrical log whose radius of 50 cm and having a length of 1.5 m."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_145():
    def __init__(self):
        ...
        choice_a = '1:1.73 #'
        choice_b = f'1:{round(random.uniform(1,2),2)}'
        choice_c = f'1:{round(random.uniform(1,2),2)}'
        choice_d = f'1:{round(random.uniform(1,2),2)}'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""The stiffness of a beam varies jointly with the breadth and the cube of the depth. Find the proportions of the stiffest beam which can be cut from a log with a given diameter."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_146():
    def __init__(self):
        ...
        choice_a = '1:1 #'
        choice_b = f'{random.randint(2,10)}:1'
        choice_c = f'{random.randint(2,10)}:1'
        choice_d = f'{random.randint(2,10)}:1'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""An open cylindrical tank was built with minimum surface area. Find the ratio of its height to its radius."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_147():
    def __init__(self):
        ...
        choice_a = '2:1 #'
        choice_b = f'{random.randint(1,10)}:1'
        choice_c = f'{random.randint(1,10)}:1'
        choice_d = f'{random.randint(1,10)}:1'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""Determine the ratio of the height to the radius of a closed cylindrical tank of a given surface area to have maximum volume."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_148():
    def __init__(self):
        ...
        choice_a = '3 m #'
        choice_b = f'{random.randint(1,10)} m'
        choice_c = f'{random.randint(1,10)} m'
        choice_d = f'{random.randint(1,10)} m'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""A closed cylindrical container was cut out of 169.6 m^2 of materials. Determine the radius of the vessel to have a maximum volume."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_149():
    def __init__(self):
        ...
        choice_a = '2 #'
        choice_b = f'{random.randint(1,10)}'
        choice_c = f'{random.randint(1,10)}'
        choice_d = f'{random.randint(1,10)}'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""A closed cylindrical tank was built with minimum surface area. Determine the ratio of its altitude to its radius."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_150():
    def __init__(self):
        ...
        choice_a = '4.5 gallons #'
        choice_b = f'{round(random.uniform(1,10),1)} gallons'
        choice_c = f'{round(random.uniform(1,10),1)} gallons'
        choice_d = f'{round(random.uniform(1,10),1)} gallons'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""A closed cylindrical tank has a capacity of 402 m^3 and minimum surface area. It is painted with antirust paint with a spreading capacity of 67 m^2 per gallon. How many gallons of paint is used?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_151():
    def __init__(self):
        ...
        self.question = f"""The diameter of a closed cylindrical tank that requires the minimum amount of materials to make it if its volume is 16pi m^3 is"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_152():
    def __init__(self):
        ...
        self.question = f"""A closed cylindrical tank has a capacity of 50.27 m^3. Determine the radius of the tank such that the amount of material used to make the tank is minimum."""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""
...
class besavilla_153():
    def __init__(self):
        ...
        choice_a = '7.74 m #'
        choice_b = f'{round(random.uniform(1,10),2)} m'
        choice_c = f'{round(random.uniform(1,10),2)} m'
        choice_d = f'{round(random.uniform(1,10),2)} m'
        
        choices = [choice_a, choice_b, choice_c, choice_d]
        random.shuffle(choices)
        
        
        self.question = f"""A closed cylindrical can is to have a volume of 108 cu. m. and a minimum total surface area. What is the sum of the base radius and the height in meters?"""
        self.answer = f"""A. {choices[0]}
B. {choices[1]}
C. {choices[2]}
D. {choices[3]}"""

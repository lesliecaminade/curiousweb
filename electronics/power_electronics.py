...
C. {CHOICES[2]}
D. {CHOICES[3]}"""
		self.latex_question = main.latex_question
		self.latex_solution = main.latex_solution    
...
class fewson_2_1():
	def __init__(self):
		...
		self.latex_question = constructed.latex_question
		self.latex_solution = constructed.latex_solution

...
class boylestad_7_1:
	def __init__(self,**kwargs): 
		...
		while regen and (not counter < 0 ):
			...
			self.question = f"""Determine: VDS for a fixed bias JFET circuit with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, VGG = {vgg.V:5.4} V, RG = {rg.Mohms:5.4} Mohms, and VSS = 0 V. The JFET has characteristics IDSS = {idss.mA:5.4} mA and Vgsoff = {vgsoff.V:5.4} V. The source is grounded."""
...
class boylestad_7_2:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine VDS for a self-biased JFET with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, RG = {rg.Mohms:5.4} Mohms, RS = {rs.kohms:5.4} kohms, and VSS = 0V. The JFET characteristics are IDSS = {idss.mA:5.4} mA and VGSoff = {vgsoff.V:5.4} V. The source resistance and the gate resistance are grounded."""
...
class boylestad_7_4:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine VDS for a voltage divider biased JFET with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, RS = {rs.kohms:5.4} kohms, R1(limiter) = {r1.Mohms:5.4} Mohms, R2(bleeder) = {r2.kohms:5.4} kohms and both the bleeder and source resistances are grounded. The JFET characteristics are IDSS = {idss.mA:5.4} mA and VGSoff = {vgsoff.V:5.4} V."""
...
class boylestad_7_5:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine VDS for a common-gate JFET configuration with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, RS = {rs.ohms:5.4} ohms, with the gate and the source resistance grounded. The JFET characteristics are IDSS = {idss.mA:5.4} mA and VGSoff = {vgsoff.V:5.4} V.""" 
...
class boylestad_7_6:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question  = f"""For an n - channel depletion type MOSFET biased by a voltage divider method, determine VDS, if VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, R1(limiter) = {r1.Mohms:5.4} Mohms, R2(bleeder) = {r2.Mohms:5.4} Mohms, RS = {rs.ohms:5.4} ohms. The bleeder resistor and the source resistor are grounded. The MOSFET characteristics are IDSS = {idss.mA:5.4} mA and VGSoff = {vgsoff.V:5.4} V."""
...
class boylestad_7_10:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine VDSQ for an enhancement type MOSFET that uses a feedback biasing arrangement with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, RF = {rf.Mohms:5.4} Mohms, and the source grounded. The MOSFET has characteristics IDon = {idon.mA:5.4} mA, VGSon = {vgson.V:5.4} V, and VGSth = {vgsth.V:5.4} V."""
...
class boylestad_7_11:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine VDS for an enhancement MOSFET in a voltage divider configuration where VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, R1(limiter) = {r1.Mohms:5.4} Mohms, RS = {rs.kohms:5.4} kohms, R2(bleeder) = {r2.Mohms:5.4} Mohms where the bleeder and the source resistors are grounded. The MOSFET has characteristics VGSth = {vgsth.V:5.4} V, IDon = {idon.mA:5.4} mA at VGSon = {vgson.V:5.4} V."""
...
class boylestad_8_7:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine: Zi, Zo, Av considering rd, and Av without considering rd, for a fixed bias JFET circuit with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, VGG = {vgg.V:5.4} V, RG = {rg.Mohms:5.4} Mohms, and VSS = 0 V. The JFET has characteristics IDSS = {idss.mA:5.4} mA and Vgsoff = {vgsoff.V:5.4} V. The source is grounded."""
		...
		self.answer = f"""{zi.Mohms:5.4} Mohms, {zo.kohms:5.4} kohms, {av:5.4}, {av_nord:5.4}"""
...
class boylestad_8_8:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine Zi, Zo with and without the effects of rd, and Av with and without the effects of rd, for a self-biased unbypased source resistance JFET with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, RG = {rg.Mohms:5.4} Mohms, RS = {rs.kohms:5.4} kohms, and VSS = 0V. The JFET characteristics are IDSS = {idss.mA:5.4} mA and VGSoff = {vgsoff.V:5.4} V. The source resistance and the gate resistance are grounded. The value of gos = {gos.uS:5.4} uS"""
		...
		self.answer = f"""{zi.Mohms:5.4} Mohms, zo w/ rd = {zo.kohms:5.4} kohms, zo w/o rd = {zo_nord.kohms:5.4} kohms, Av w/ rd = {av:5.4}, Av w/o rd = {av_nord:5.4}"""   
...
class boylestad_8_9:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine: Zi with and without considering rd, Zo with and without considering rd, and Vo with and without considering rd for a common-gate JFET configuration with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, RS = {rs.ohms:5.4} ohms, with the gate and the source resistance grounded. The JFET characteristics are IDSS = {idss.mA:5.4} mA, VGSoff = {vgsoff.V:5.4} V, gos = {gos.uS:5.4} uS and the input is a {vi.mV:5.4} mV signal.""" 
		...
		self.answer = f"""zi w/ rd= {zi.kohms:5.4} kohms, zi w/o rd = {zi_nord.kohms:5.4} kohms, zo w/ rd = {zo.kohms:5.4} kohms, zo w/o rd = {zo_nord.kohms:5.4} kohms, vo w/ rd = {vo.V:5.4} V, vo w/o rd = {vo_nord.V:5.4} V"""  
...
class boylestad_8_10:
	def __init__(self,*args,**kwargs): 
		...
		self.answer = f"""zi = {zi.kohms:5.4} kohms, zo w/ rd = {zo.kohms:5.4} kohms, zo w/o rd = {zo_nord.kohms:5.4} kohms, av w/ rd = {av:5.4}, av w/o rd = {av_nord:5.4}"""
...
class boylestad_8_11:
	def __init__(self,*args,**kwargs): 
		...
		self.answer = f"""{zi.Mohms:5.4} Mohms, {zo.kohms:5.4} kohms, {av:5.4}"""
...
class boylestad_8_12:
	def __init__(self,*args,**kwargs): 
		...
		while regen:
			...
			self.question = f"""Determine Zi with and without rd, Zo with and without rd, and Av with and without rd, for an enhancement type MOSFET that uses a feedback biasing arrangement with VDD = {vdd.V:5.4} V, RD = {rd.kohms:5.4} kohms, RF = {rf.Mohms:5.4} Mohms, and the source grounded. The MOSFET has characteristics IDon = {idon.mA:5.4} mA, VGSon = {vgson.V:5.4} V, and VGSth = {vgsth.V:5.4} V. Note also that gos = {gos.uS:5.4} uS"""
		...
		self.answer = f"""Zi w/ rd = {zi.Mohms:5.4} Mohms, Zi w/o rd = {zi_nord.Mohms:5.4} Mohms, Zo w/ rd = {zo.kohms:5.4} kohms, Zo w/o rd = {zo_nord.kohms:5.4} kohms, Av w/ rd = {av:5.4}, Av w/o rd = {av_nord:5.4}"""
